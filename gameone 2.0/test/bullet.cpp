...
Bullet::Bullet(int type,QPoint startPos, QPoint targetPoint, int damage, Enemy *target,
               MainWindow *game, const QPixmap &sprite, const QPixmap &sprite2)
    : m_startPos(startPos)
...
void Bullet::draw(QPainter *painter) const
{
    ...
    if(mtype==2)
        painter->drawPixmap(m_currentPos, m_sprite2);
